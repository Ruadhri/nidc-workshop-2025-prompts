...
A modern, web-based Logic Grid Puzzle Solver project developed during the NIDC Workshop 2025. This project aims to transform classic logic grid puzzles into an interactive digital experience where users can deduce relationships between multiple categories from given clues.

## Project Overview

This repository contains the development of a Logic Grid Puzzle Solver with a focus on:
...
(Development in progress - Setup instructions will be added as the project evolves)
